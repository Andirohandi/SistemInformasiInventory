...
?>
<html>
<head><title>Penerimaan Barang | Sistem Inventory IWU</title></head>
...
$(document).ready(function(){
    ...
    menu.animate({width:'740px',opacity:'0.8'},"slow");
	});
});
...
<div id="badan">
	...
	<div id="menu">
		<div id="title_menu">
			<b><a href="#">Penerimaan Barang</a></b>
		</div>
		<div id="menu_pp">
			<div id="pil_menu">
				<a href="input_terima_barang.php"><div id="sub_menu"><h3>Input Penerimaan Barang</h3></div></a>
			</div>
			<div id="pil_menu">
				<a href="data_penerimaan_barang.php"><div id="sub_menu"><h3>Data Penerimaan Barang</h3></div></a>
			</div>
			<div id="pil_menu">
				<a href="data_sisa_po.php"><div id="sub_menu"><h3>Sisa PO Belum Terealisasi</h3></div></a>
			</div>
			<div id="pil_menu">
				<a href="validasi_retur.php"><div id="sub_menu"><h3>Validasi Retur Produksi</h3></div></a>
			</div>
			<div id="pil_menu">
				<a href="data_retur_prod.php"><div id="sub_menu"><h3>Data Retur dari Produksi</h3></div></a>
			</div>
			<div id="log_out">
				<h3>KELUAR</h3>
			</div>
