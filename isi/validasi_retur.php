...
$(document).ready(function(){
	...
	$("#simpan_p").click(function(){
		var no_val = $('#no_val_r').val();
		$('#no_val_r_p').val(no_val+" ?");
...
function simpan_val(){
	...
	$.post("simpan_val_ret.php",{id_nm:id_nm, unit:unit, kode:kode, no_val:no_val, tgl_val:tgl_val, no_ret:no_ret}, function(dataJSON){
...
function panggil_retur(){
	...
	if(no_ret==""){
		...
		$.post("panggil_retur_prod.php",{no_ret:no_ret}, function(dataJSON){
			var data = jQuery.parseJSON(dataJSON);
			$('#kode').val(data.kode);
...
<div id="badan">
	...
	<div id="knf_save">
		<div id="head_knf">
			...
			<p>Apakah anda yakin akan memverifikasi retur dari produksi dengan nomor<input type="text" name="no_val_r_p" id="no_val_r_p" readonly class="knf_form"/></p>
			<div id="ktk_eks">
				<div id="tomb_eks_knf">
	...
	<div id="badan_program">
		...
		<div id="bada_program_kanan">
			...
			<div id="title_program">
				<h2>Program Validasi Retur Produksi</h2>
			</div>
			<br/>
			<div id='search-box'>
			...
			<div id="prog_ppb">
					<table>
						<tr>
							...
							<td> : </td>
							<td><input type="text" id="no_val_r" name="no_val_r" class="input1" style="cursor:not-allowed;background-color:purple;color:white;" value="<?php no_val_ret() ?>" readonly value=""/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td> : </td>
							<td><input type="text" id="no_ret" name="no_ret" class="input1" style="" value="" onchange="panggil_retur()"/></td>
						</tr>
						<tr>
					...
					<table class="table1">
						...
						<tr>
							<td>
							<input type="text" name="id_nm" id="id_nm" class="inputid" style="text-align:center;cursor:not-allowed;" value="<?php id_val_ret() ?>" readonly /></td>
							<td><input type="text" name="kode" id="kode" class="input2" style="cursor:not-allowed;""/></td>
							...
							<td><input type="text" name="unit" id="unit" class="input2" style="text-align:center;cursor:not-allowed;" /></td>
