...
function cari2(term){
	$.post("search_data_sisa_po.php",{term: term}, function(dataJSON){
		...
		for(var i=0;i<data.length;i++){
			...
			content +="<td align='center'>"+data[i].po_datang+"</td>";
			content +="<td align='center'>"+data[i].sisa_po+"</td>";
		...
		$("#tbody_table").empty().append(content);
	});
}
						...
						<table border="1px" style="border-collapse:collapse">
							<thead>
								<tr height="50px">
									...
									<th width="70px">Jmlh PO</th>
									<th width="90px">PO Datang</th>
									<th width="90px">Sisa PO</th>
