...
function cari2(term){
	$.post("search_pembatalan_ppb.php", {term:term}, function(dataJSON){
		var content = '';
		var counter = 1;
		...
		for(var i=0; i<data.length; i++){
			...
			content += "<td>"+data[i].tgl_ppb_batal+"</td>";
		...
		$("#tbody_tabel").empty().append(content);
	});
}
					...
					<div id="tabs-1">
						<table border="1px" style="border-collapse:collapse">
							...
							<tbody id="tbody_tabel">
								<?php
									load_table_data_pembatalan_ppb();
								?>
							</tbody>
						</table>
						<br/></br>
