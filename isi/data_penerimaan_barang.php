...
function cari2(term){
	$.post("search_penerimaan_barang.php", {term:term}, function(dataJSON){
		...
		for(var i=0; i<data.length; i++){
			...
			content += "<td align='center'>"+data[i].packing+"</td>";
		...
		$("#tbody_tbl_data_penerimaan").empty().append(content);
	});
}
function kembali(){
	window.history.go(-1);
