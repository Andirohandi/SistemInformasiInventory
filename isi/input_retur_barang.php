...
$(document).ready(function(){
	...
	$( "#search-text" ).autocomplete({
		source: "returprod_autocomplete.php",
		autoFocus: true,
		maxHeight:350,
		zIndex: 9999
	});
...
function lihat(){
	...
	if(search==""){
		...
		$.post("cari_retur_prod.php",{search: search}, function(dataJSON){
		data = jQuery.parseJSON(dataJSON);
		$('#no_ret').val(data.no_ret);
		$('#no_bkb').val(data.no_bkb);
		$('#tgl_ret').val(data.tgl_ret);
...
function simpan_retur(){
	...
	$.post("simpan_retur.php",{no_ret:no_ret, no_bkb:no_bkb, tgl_ret:tgl_ret, kategori:kategori, ket:ket, id_nm:id_nm, kode:kode, kodebb:kodebb, sat:sat, unit:unit, tonage:tonage}, function(dataJSON){
...
function edit_retur(){
	...
	$.post("edit_retur.php",{no_ret:no_ret, no_bkb:no_bkb, tgl_ret:tgl_ret, kategori:kategori, ket:ket, id_nm:id_nm, kode:kode, kodebb:kodebb, sat:sat, unit:unit, tonage:tonage}, function(dataJSON){
		var data = jQuery.parseJSON(dataJSON);
...
function batal_retur(){
	...
	$.post("batal_retur.php",{no_ret:no_ret}, function(dataJSON){
		var data = jQuery.parseJSON(dataJSON);
...
<div id="badan">
	...
	<div id="knf_save">
		<div id="head_knf">
			...
			<p>Apakah anda yakin akan melakukan RETUR dengan nomor<input type="text" name="no_ret_p" id="no_ret_p" readonly class="knf_form"/></p>
			<div id="ktk_eks">
				<div id="tomb_eks_knf">
					<input type="button" name="simpan" id="simpan" value="Simpan" class="submitt" onclick="simpan_retur()" />
				</div>
				<div id="tomb_eks_knf">
	...
	<div id="knf_edit">
		<div id="head_knf">
			...
			<p>Apakah anda yakin akan memperbarui PPB dengan nomor<input type="text" name="no_ret_e" id="no_ret_e" readonly class="knf_form"/></p>
			<div id="ktk_eks">
				<div id="tomb_eks_knf">
					<input type="button" name="perbarui" id="perbarui" value="Perbarui" class="submitt" onclick="edit_retur()" />
				</div>
				<div id="tomb_eks_knf">
	...
	<div id="knf_batal">
		<div id="head_knf">
			...
			<p>Apakah anda yakin akan MEMBATALKAN RETUR dengan nomor<input type="text" name="no_ret_b" id="no_ret_b" readonly class="knf_form"/></p>
			<div id="ktk_eks">
				<div id="tomb_eks_knf">
					<input type="button" name="batal" id="batal" value="Batal" class="submitt" onclick="batal_retur()" />
				</div>
				<div id="tomb_eks_knf">
	...
	<div id="badan_program">
		...
		<div id="bada_program_kanan">
			...
			<div id="prog_ppb">
					<table>
						<tr>
							<td height="40">No. Retur</td>
							<td> : </td>
							<td><input type="text" id="no_ret" name="no_ret" class="input1" style="cursor:not-allowed;background-color:yellow" readonly value="<?php noreturp(); ?>"/></td>
						</tr>
						<tr>
					...
					<table class="table1">
						...
						<tr>
							<td>
							<input type="text" name="id_nm" id="id_nm" class="inputid" style="text-align:center;cursor:not-allowed;" value="<?php id_ret() ?>" readonly /></td>
					...
					<div id="kotak_eksekusi">
						...
						<div id="tomb_eks">
							<input type="submit" class="submitt" value="Dt Retur" name="dataretur" id="dataretur"/>
						</div>
						<div id="tomb_eks">
